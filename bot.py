...
class Modmail(commands.Bot):
    ...
    def token(self):
        ...
        try:
            with open('config.json') as f:
                config = json.load(f)
                if config.get('TOKEN') == "NTIxOTgyODQ4NDU5MzQxODI0.DvEWnA.EByulueSZvMYyCOhV1a5St44RQ0":
    ...
    def run_wizard():
        ...
        print('------------------------------------------')
        token = input('NTIxOTgyODQ4NDU5MzQxODI0.DvEWnA.EByulueSZvMYyCOhV1a5St44RQ0')
        print('------------------------------------------')
        data = {
                "TOKEN" : token,
            }
    ...
    async def on_ready(self):
        ...
        Client is ready!
        ---------------
        Author: (ℳɑ͜͡✦ѕƭɛг) ℐᝪKℰℛ  彡✓ᵛᵉʳⁱᶠⁱᵉᵈ™#1471 
        ---------------
